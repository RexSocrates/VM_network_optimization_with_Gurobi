...
testValueList = [0]
testValueList.extend([val for val in range(20, 151, 10)])
testValueList.reverse()

testValueList2 = [0]
testValueList2.extend([val for val in range(20, 151, 10)])
testValueList2.reverse()
...
for testValue in testValueList :
    for testValue2 in testValueList2 :
	    ...
	    writeModelResult('modelResult_' + str(testValue) + '_' + str(testValue2) + '.csv', resultColumn, resultData)
	    # print(GRB.OPTIMAL)    